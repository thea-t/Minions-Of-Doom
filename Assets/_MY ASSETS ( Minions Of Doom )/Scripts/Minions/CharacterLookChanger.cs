...
public class CharacterLookChanger : MonoBehaviour
{
    ...
    /// <summary>
    /// Setting the characters look and attachments from CharacterLookData
    /// Context menu adds this function to the menu options so that you can call it in the editor.
    /// </summary>
    ...
    /// <summary>
    /// Destroy previously created attachments if there are any
    /// </summary>
